...
import { serverTimestamp, serverTimeStamp, updateDoc, getDoc, doc } from 'firebase/firestore'
...
const EditListing = () => {
  ...
  useEffect(()=> {
    ...
    const fetchListing = async () => {
      const docRef = doc(db, 'listings', params.listinId)
